...
Keys = Sprite:extend{
	...
	new = function (self, obj)
		obj = self:extend(obj)
		the.keys = obj
		local loveKeypressed = nil
		if love.keypressed then
			loveKeypressed = love.keypressed
		end
		love.keypressed = function (key, unicode) 
			if loveKeypressed then
				loveKeypressed(key, unicode)
			end
			obj:keyPressed(key, unicode) 
		end

		local loveKeyreleased = nil
		if love.keyreleased then
			loveKeyreleased = love.keyreleased
		end
		love.keyreleased = function (key, unicode) 
			if loveKeyreleased then
				loveKeyreleased(key, unicode)
			end
			obj:keyReleased(key, unicode) 
		end
