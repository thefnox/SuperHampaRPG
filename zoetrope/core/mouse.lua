...
Mouse = Sprite:extend{
	...
	new = function (self, obj)
		obj = self:extend(obj)
		the.mouse = obj
		local loveMousepressed = nil
		if love.mousepressed then 
			loveMousepressed = love.mousepressed
		end
		love.mousepressed = function (x, y, button) 
			if loveMousepressed then 
				loveMousepressed(x, y, button)
			end
			obj:mousePressed(button) 
		end

		local loveMousereleased = nil
		if love.mousereleased then 
			loveMousereleased = love.mousereleased
		end
		love.mousereleased = function (x, y, button) 
			if loveMousereleased then 
				loveMousereleased(x, y, button)
			end
			obj:mouseReleased(button) 
		end
